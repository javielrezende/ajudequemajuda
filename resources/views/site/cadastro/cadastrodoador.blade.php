...
@section('content')
    ...
    <div class="row cadastrodoador">
        ...
        <form class="row formcadastro" method="post" enctype="multipart/form-data" action="{{route('aqa.store')}}">
            ...
            <div class="col-sm-6">
                {!!"<img src='https://s3-sa-east-1.amazonaws.com/ajudequemajuda/geral/avatar1.jpg' id='imagem_preview' height='150px' width='150px' alt='Foto do perfil' class='rounded-circle'>"!!}
            </div>
