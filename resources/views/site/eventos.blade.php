...
@section('content')
    ...
    <div class="row siteeventos">
        <p class="row col-md-12 tituloeventos">Eventos</p>
        ...
        <div class="row col-6">
            <div class="row diveventos">
                <img class="row imagemeventos" src="{{ asset('imagens/campanhadestaque.png') }}" alt="Imagem destque">
                <div class="col-6 row observacoeseventos">
                    <h4 class="nomeeventos">Evento 1</h4>
                    <p class="dataeventos">22/03/2018</p>
                    <p class="descricaoeventos">Lorem ipsum dolor sit amet, con...</p>
                    <a href="#" class=" align-content-end saibamaiseventos">Saiba mais</a>
                </div>
            </div>
        </div>
    </div>
